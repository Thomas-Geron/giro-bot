# ui_animacao.py — cópia do MarketplaceBot (mesmo sistema visual; mudar lá e cá)
"""
...
- `GIROBOT_SEM_ANIMACAO=1` no ambiente desliga tudo (cada animação vai
...
ATIVO = os.environ.get("GIROBOT_SEM_ANIMACAO", "") != "1"
QUADRO_MS = 16
