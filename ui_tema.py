# ui_tema.py — do MarketplaceBot, com as cores do Giro (mudar lá e cá)
"""
Tokens e estilos do visual do Giro Bot — o mesmo sistema do MarketplaceBot.

Identidade: lateral escura, conteúdo claro, o VINHO do Giro (#A63348, o do
site) como cor principal, azul de apoio, verde/âmbar/vermelho só para estado.
As bordas de campo são mais escuras que as do MarketplaceBot: é o contraste
mínimo de 3:1 que o site usa para o campo ser visto. Toda cor, fonte, espaço e
...
def get_resource_dir() -> Path:
    """Raiz dos recursos (assets/): a pasta do exe congelado ou a do código."""
    return Path(getattr(sys, "_MEIPASS", Path(__file__).resolve().parent))

CORES = {
    # identidade (as do site do Giro, tema claro)
    "primaria": "#a63348",
    "primaria_hover": "#8e2b3d",
    "primaria_pressao": "#742334",
    "primaria_suave": "#fbedef",
    "primaria_borda": "#efc6ce",
    "primaria_texto": "#8e2b3d",
    "secundaria": "#1f5fad",
    "sucesso": "#16a34a",
    "aviso": "#f59e0b",
    "erro": "#dc2626",
    ...
    "texto_suave": "#5e5054",
    "placeholder": "#8c7f82",
    "inativo_fundo": "#f2eced",
    "inativo_texto": "#a89b9e",
    "info_fundo": "#e7f0fb",
    # lateral
    "lateral": "#1b1517",
    "lateral_hover": "#2d2427",
    "lateral_texto": "#e4dadc",
    "lateral_suave": "#9a8c90",
}
...
SELOS = {
    ...
    "aviso": ("#fbf1da", "#7a4f00"),
    "erro": ("#fbebe8", "#b42d1e"),
    "neutro": ("#f2eced", "#5e5054"),
    "primaria": ("#fbedef", "#8e2b3d"),
}
...
_BOTOES = {
    "Primario": dict(fill=CORES["primaria"], hover=CORES["primaria_hover"],
                     ...
                     inativo_fill="#dba3ae", inativo_texto="#fbedef",
                     fundo=CORES["cartao"]),
    "Secundario": dict(fill="#ffffff", borda=CORES["borda_campo"],
                       ...
                       fundo=CORES["cartao"]),
    "Destaque": dict(fill=CORES["primaria_suave"], borda="#e3a9b5",
                     hover="#f7dde2", hover_borda=CORES["primaria"],
                     pressao="#efc6ce", texto=CORES["primaria_texto"],
                     inativo_fill="#f8fafc", inativo_borda="#e2e8f0",
                     inativo_texto=CORES["inativo_texto"],
                     fundo=CORES["cartao"]),
    ...
    "IconePerigo": dict(fill=CORES["cartao"], hover="#fef2f2",
                        ...
                        inativo_texto=CORES["inativo_texto"],
                        fundo=CORES["cartao"]),
    "Lateral": dict(fill=CORES["lateral"], borda="#3d3236",
                    hover=CORES["lateral_hover"], hover_borda="#54474b",
                    pressao="#3d3236", texto=CORES["lateral_texto"],
